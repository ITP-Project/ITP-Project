  ...
  <div class="w3-main" style="margin-left:340px;margin-right:40px">
	...
	<div class="w3-container ">
		<div class="w3-row-padding">
			<div class="allEvents" style="overflow-y: auto; height:500px;">
				<?php
					...
					while($row = $result->fetch_assoc()){
						...
						echo '<a href="ViewMoreDisplay.php?id='.$eventID.'">View More</a>';
						echo '</div>';
						echo '</div>';
						echo '</div>';
					}
	...
	<div class="w3-container ">
		<div class="w3-row-padding">
			...
			<hr style="width:50px;border:5px solid red" class="w3-round">
			<div class="comEvents" style="overflow-y: auto; height:500px;">
				<?php
	...
	<div class="w3-container ">
		<div class="w3-row-padding">
			...
			<hr style="width:50px;border:5px solid red" class="w3-round">
			<div class="ownEvents" style="overflow-y: auto; height:500px;">
				<?php
